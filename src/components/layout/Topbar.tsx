...
const Topbar: React.FC = () => {
  ...
  const title = routeTitles[pathname] || 'Mission Control'
  ...
  const currentMode = (theme as ThemeMode) || 'dark'
  const ThemeIcon = themeIcons[currentMode] || Moon
  ...
  return (
    <header style={styles.topbar}>
      ...
      <div style={styles.rightSection}>
        ...
        <button style={styles.themeBtn} onClick={cycleTheme} title={`Tema: ${currentMode}`}>
